...
class Ingredient {
    ...
    static func getIngredientWeb(id: Int) -> String?{
        ...
        let request = NSMutableURLRequest(url: NSURL(string: "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/\(id)/ingredientWidget?defaultCss=true")! as URL,
        ...
        dataTask.resume()
        group.wait()
        print("before return: \(htmlString)")
        return htmlString
